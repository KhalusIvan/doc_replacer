...
const titles = {
    ...
    'VIN' : 'ВІН-код авто',
    'price' : 'Ціна авто',
    'sum_usd' : 'Вартість послуг AW в доларах',
    'sum_uah' : 'вартість послуг AW в гривнях в дужках словами',
    'date_rod' : 'Дата в родовому відмінку місяць - словами',
    'avans' : 'Аванс для договору ЄВРОПА',
    'ostatok' : 'Залишок до сплати для договору ЄВРОПА'
};
          ...
          {Object.keys(data).map((key) => {
              return (
                  <div key={key} style={{display: 'flex', justifyContent: 'flex-start', marginTop: 12}}>
                      <label style={{width: 350}}>{titles[key]}</label>
